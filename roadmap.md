...
- [x] Change the Kativate review password to `carebear`
- [x] Add the password-gated food truck review page with all four supplied graphics
- [x] Add the discreet footer link and route
- [x] Verify both review flows and responsive layout
...
- [ ] Add the password-gated Oktoberfest review route and discreet footer link
- [ ] Add the supplied Oktoberfest previews and downloadable handoff archive
- [ ] Verify access, navigation, downloads, metadata, and responsive layout
